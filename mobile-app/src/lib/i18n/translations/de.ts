...
export const de = {
  ...
  dataPrivacyScreen: {
    ...
    privacyInfo: 'Ihr GPS-Standort verlässt niemals Ihr Telefon. Alle Arbeitssitzungen werden lokal gespeichert.\n\nWenn Sie Ihre Wochenzusammenfassung senden, werden nur die wöchentlichen Gesamtstunden geteilt. Ihre Daten werden mit anderen Nutzern kombiniert und mathematisch geschützt, bevor Statistiken veröffentlicht werden.',
