...
export const de = {
  ...
  calendar: {
    ...
    absences: {
      ...
      sick: 'Krankheit',
      fullDay: 'Ganzer Tag',
      hint: 'Wählen Sie einen Abwesenheitstyp aus und doppeltippen Sie dann auf einen Tag.',
  ...
  auth: {
    ...
    register: {
      ...
      professionRequiredMessage: 'Bitte wählen Sie Ihren Beruf',
  ...
  settings: {
    ...
    calendarExportFailed: 'Export fehlgeschlagen. Bitte versuchen Sie es erneut.',
    ...
    calendarSyncDisableMessage: 'Wählen Sie, ob exportierte Kalendereinträge in Ihrem Gerätekalender bleiben sollen.',
    ...
    calendarSyncDeleteBlockedMessage: 'Die App kann exportierte Einträge nicht entfernen, solange der Kalenderzugriff deaktiviert ist. Sie können den Zugriff in den Einstellungen wieder aktivieren oder die exportierten Einträge vorerst behalten und später manuell entfernen.',
    calendarSyncOpenSettings: 'Einstellungen öffnen',
    calendarSyncPickerTitle: 'Kalender wählen',
    calendarSyncPickerMessage: 'Wählen Sie das Kalenderkonto für den exportierten Kalender.',
  ...
  dataPrivacyScreen: {
    ...
    weeklySubmissions: 'Wöchentliche Übermittlungen',
    weeklySubmissionExplainer: 'Wochensummen werden gesendet, wenn Sie sie für Sonntag einreihen oder Auto-Senden aktiviert ist. Es werden nur Gesamtstunden geteilt — keine täglichen Details.',
    queued: 'Eingereiht:',
    sent: 'Gesendet:',
    deleteAllData: 'Lokale Daten löschen',
    deleteConfirmTitle: 'Lokale Daten löschen?',
    deleteConfirmMessage: 'Möchten Sie wirklich alle lokalen Daten löschen?\n\nDies entfernt dauerhaft:\n• Alle Arbeitsorte\n• Alle Arbeitssitzungen\n• Den gesamten Erfassungsverlauf\n\nIhr Konto bleibt aktiv.',
    ...
    withdrawConfirmMessage: 'Dies wird Ihr Konto und alle Daten dauerhaft von unseren Servern löschen. Ihre lokalen Daten werden ebenfalls gelöscht.\n\nDiese Aktion kann nicht rückgängig gemacht werden.',
    withdrawConfirmButton: 'Alles löschen',
    pendingDataTitle: 'Ausstehende Daten',
    pendingDataWarning: 'Sie haben {{count}} Woche(n) mit eingereihten Daten, die nicht übermittelt werden, wenn Sie fortfahren.',
    continueAnyway: 'Trotzdem fortfahren',
    accountDeleted: 'Konto gelöscht',
    accountDeletedMessage: 'Ihr Konto und alle zugehörigen Daten wurden dauerhaft gelöscht.',
    deletionFailed: 'Konto konnte nicht gelöscht werden. Bitte versuchen Sie es erneut.',
    ...
    calendarCleanupManualMessage: 'Die lokalen App-Daten wurden gelöscht, aber exportierte Kalendereinträge können weiterhin vorhanden sein. Wenn der Kalenderzugriff deaktiviert ist, aktivieren Sie ihn erneut oder entfernen Sie die Einträge manuell in Ihrer Kalender-App.',
  },
  ...
  reports: {
    ...
    week: {
      ...
      availableSundayEvening: 'Alle Tage bestätigt — ab Sonntagabend verfügbar',
    ...
    firstTime: {
      ...
      bullet3: 'Sobald eine Woche gesendet ist, kann sie nicht rückgängig gemacht werden',
      gotIt: 'Verstanden',
    },
  },
  ...
  notifications: {
    ...
    sundayUnconfirmedBody: 'Sie haben {{count}} unbestätigte(n) Tag(e) diese Woche. Öffnen Sie die App, um sie zu bestätigen.',
    sundayQueueTitle: 'Bereit für heute Abend?',
    sundayQueueBody: '{{week}} ist vollständig bestätigt. Öffnen Sie die App nach 18:00, um die Woche einzureihen.',
    sundayReadyTitle: 'Wochendaten bereit',
    sundayReadyBody: 'Ihre wöchentlichen Stunden sind bereit. Öffnen Sie die App zum Einreihen oder Senden.',
  },
};
