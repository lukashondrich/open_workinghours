...
export const en = {
  ...
  onboardingTooltips: {
    ...
    calendar: {
      ...
      body: 'Plan your shifts here. The app compares planned hours with automatically tracked hours and shows the difference in your dashboard.',
    },
    fab: {
      title: 'Add calendar details',
      body: 'Plan shifts, mark vacation or sick days, or log working time manually if GPS missed a shift.',
    },
    batch: {
    ...
    trackedSession: {
      title: 'Automatically tracked time',
      body: 'This time was tracked via GPS. Confirm the day in Calendar so the full week can be submitted later.',
    },
  },
  ...
  calendar: {
    header: {
      ...
      week: 'Week',
      month: 'Month',
      dailySubmissions: 'Confirm Days',
      allConfirmed: 'All days confirmed',
      daysConfirmed: '{{count}}/7 days confirmed',
      submissionsHint: 'Confirm each day so the week can be submitted in Reports.',
      reviewHint: 'Enter GPS mode to review and confirm tracked days.',
      submitHint: 'Confirm days to finalize the week',
      weekComplete: 'Weekly contribution ready — open Reports',
      weekScheduled: 'Weekly contribution ready ✓ — sends Sunday evening',
      weekSending: 'Sending weekly contribution…',
      weekSent: 'Weekly contribution sent ✓ — open Reports',
      weekSendFailed: 'Sending failed — will retry automatically',
      weekSendAuthExpired: 'Sending paused — tap to sign in again',
      reloginTitle: 'Session expired',
      reloginMessage: 'Your session has expired, so your weekly contribution could not be sent. Sign in again to resume — all your data stays on this device.',
      reloginConfirm: 'Sign in',
      // Accessibility
    ...
    dayLock: {
      ...
      unconfirmFailedTitle: 'Could not un-confirm day',
      unconfirmFailedMessage: 'Something went wrong while reopening this day. The day is still confirmed — please try again.',
    },
    week: {
      submit: 'Confirm',
      submitShort: '✓',
      submitTooltipTitle: 'Confirm Day',
      submitTooltipBody: 'This confirms the day for your weekly overview. Sending happens later, for a complete week in Reports.',
      ...
      breakExceedsTitle: 'Break exceeds shift duration',
      breakExceedsMessage: 'Total break ({{breakDuration}}) is longer than the shift duration ({{sessionDuration}}). Net time will be 0.',
      breakAddError: 'Could not add break. Please try again.',
      breakClearError: 'Could not clear break. Please try again.',
      deleteError: 'Could not delete this time entry. Please try again.',
  ...
  auth: {
    ...
    register: {
      ...
      logIn: 'Log in',
      privacyNotice: 'By creating an account, you agree to our privacy policy. Your weekly contributions flow into anonymized, aggregated statistics.',
      // Alerts
  ...
  consent: {
    ...
    keyPoints: {
      title: 'In short:',
      localData: 'GPS coordinates, workplace names, shift templates, absences, and unconfirmed time entries stay on your device.',
      submission: 'Your profile and confirmed weekly totals are sent to Open Working Hours.',
      publicStats: 'Only anonymized, aggregated statistics are published, for groups of 5+ people. Statistical noise additionally protects against re-identification.',
      deletion: 'You can delete your account and your personal server data anytime. Already-published aggregated statistics are retained anonymously.',
    },
    privacyExplainer: 'How your data is protected',
    checkbox: 'I agree to the Terms of Service and Privacy Policy',
    accept: 'I Agree & Continue',
    updateFailed: 'Consent could not be saved. Please try again.',
  ...
  hoursExplainer: {
    ...
    plannedBody: 'Planned shifts minus absences (vacation, sick).',
  ...
  settings: {
    ...
    reportIssueTitle: 'Send bug report?',
    reportIssueIntro: 'This sends a diagnostic snapshot so the developer can investigate the issue.',
    reportIssueDescriptionPlaceholder: 'What happened? Optional, but helpful.',
    reportIssueDefaultDataTitle: 'Sent by default',
    reportIssueDefaultDataBody: 'App version, build number, device model, OS version, work-location count, work-event count, and recent geofence accuracy/ignore telemetry without workplace names or coordinates.',
    reportIssueLocationDiagnostics: 'Include location diagnostics',
    reportIssueLocationDiagnosticsBody: 'Adds saved workplace names, approximate coordinates rounded to about 100 m, and recent geofence events with workplace names.',
    reportIssueRetention: 'Bug reports are deleted after 90 days, or sooner if your account is deleted.',
    reportIssueSend: 'Send report',
    ...
    clearAllDataConfirm: 'This will delete all locations, time entries, and calendar data. Continue?',
  ...
  setup: {
    ...
    foregroundPrimer: {
      ...
      privacy: 'GPS coordinates are processed on your device for clock-in/out detection. Workplace search uses Photon (Komoot, Germany) to find places — see the Privacy Policy for details.',
    ...
    backgroundPrimer: {
      ...
      privacy: 'GPS coordinates and workplace names stay on this device. Your profile and confirmed weekly totals are sent when you submit a complete week in Reports or enable auto-send.',
      enable: 'Enable Automatic Tracking',
      skip: 'Track Manually Instead',
    },
    notificationPrimer: {
      title: 'Get clock-in/out confirmations',
      body: 'Notifications let you know when the app clocks you in or out and help verify when a tracked time entry should end.',
  ...
  log: {
    // Empty state
    noSessions: 'No Time Entries Recorded',
    noSessionsHint: 'Time entries tracked at this location will appear here',
    ...
    // Summary
    sessionCount: '{{count}} entries',
    sessionCountOne: '1 entry',
  ...
  dataPrivacyScreen: {
    ...
    weeklySubmissions: 'Weekly Contributions',
    weeklySubmissionExplainer: 'Weekly totals are submitted when you queue a complete week for Sunday or have auto-send enabled. Only total hours are sent — no individual days or shifts.',
    queued: 'Queued:',
    sent: 'Sent:',
    ...
    privacyInfo: 'GPS coordinates, workplace names, shift templates, absences, and unconfirmed time entries stay on your phone.\n\nWhen you submit a complete week, your profile and the confirmed weekly total are sent to Open Working Hours. Only anonymized, aggregated statistics are published, for groups of 5+ people; statistical noise additionally protects against re-identification.',
    // Consent withdrawal section
    withdrawConsent: 'Withdraw Consent & Delete Account',
    withdrawConfirmTitle: 'Delete Account?',
    withdrawConfirmMessage: 'This will permanently delete your account and your personal server data. Your local data will also be cleared.\n\nThis action cannot be undone.',
    ...
    accountDeletedMessage: 'Your account and the associated server data have been permanently deleted.',
    ...
    withdrawWarning: 'Withdrawing consent will permanently delete your account and your personal server data. This includes submitted weekly totals. Already-published anonymized, aggregated statistics are retained.',
    // Data export section
  ...
  manualSession: {
    ...
    errorOverlap: 'Overlaps with existing time entry',
  ...
  reports: {
    ...
    collective: {
      ...
      share: 'Share App',
      shareMessage: 'Open Working Hours is an app for healthcare workers to track working hours transparently and make anonymized, aggregated statistics visible. The more people participate, the more meaningful the collective data.',
      avgPlanned: 'Planned',
      avgActual: 'Actual',
    ...
    // Submissions section
    submissions: {
      title: 'Your Weekly Contributions',
      autoSend: 'Auto-send',
      autoSendHint: 'Confirmed weeks are sent automatically on Sundays',
    },
    // Week card states
    week: {
      label: 'KW {{number}}',
    ...
    sent: {
      title: 'Sent',
      chip: 'Sent',
      weeksContributed: '{{count}} weekly contributions sent',
      export: 'Export',
    },
    errors: {
    ...
    firstTime: {
      ...
      body: 'By submitting this week, you contribute your confirmed weekly total to Open Working Hours.',
      bullet1: 'GPS coordinates stay on your device',
      bullet2: 'Only anonymized, aggregated statistics are published',
      bullet3: 'A sent weekly contribution cannot be undone',
      gotIt: 'Got it',
    },
  },
