        ...
        <div className="max-w-5xl mx-auto px-6 py-10 text-sm text-slate-600 space-y-6">
          ...
          <div className="space-y-2 text-xs text-slate-600">
            ...
            <p className="text-slate-500 leading-relaxed">
              Hinweis: Dieses Projekt befindet sich in einem frühen Entwicklungsstadium und enthält keine produktiven oder
          ...
          <div className="space-y-2 text-xs text-slate-600">
            ...
            <p className="leading-relaxed">
              Diese Website speichert oder verarbeitet keine personenbezogenen Daten. Es werden keine Cookies gesetzt, keine
              Analysetools verwendet und keine Daten an Dritte weitergegeben.
            </p>
            <p className="leading-relaxed">
              Sollten zukünftig Funktionen hinzukommen, bei denen personenbezogene Daten verarbeitet werden (z. B.
              Kontaktformular, Tracking oder Nutzungsanalyse), wird diese Datenschutzerklärung entsprechend angepasst.
            </p>
          </div>
        </div>
      </footer>
